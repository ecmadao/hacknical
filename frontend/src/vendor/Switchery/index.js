...
function setSize(options) {
  var defaultOptions = objectAssign({}, defaults);
  ...
  switch (options.size) {
    case 'small':
      defaultOptions.className = defaultOptions.className + ` ${small}`;
      break;
    case 'large':
      defaultOptions.className = defaultOptions.className + ` ${large}`;
      break;
    default:
      break;
  }
